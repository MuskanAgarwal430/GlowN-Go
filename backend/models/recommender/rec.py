...
df2 = pd.read_csv(r"C:\Users\hp\Desktop\Skyn-main\backend\models\recommender\final.csv")
makeup = pd.read_csv(r"C:\Users\hp\Desktop\Skyn-main\backend\models\recommender\makeup_final.csv")
entries = len(df2)
...
def makeup_recommendation(skin_tone, skin_type):
    ...
    dff = pd.concat([
        dff,
        makeup[(makeup['skin tone'] == skin_tone) & (makeup['skin type'] == skin_type) & (
